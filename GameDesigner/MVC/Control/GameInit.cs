...
namespace MVC.Control
{
    ...
    public class GameInit : SingleCase<GameInit>
    {
        ...
        public string entryType = "Hotfix.GameEntry";
        ...
        void Start()
        {
            ...
            var method = appdomain.LoadedTypes[entryType].GetMethod("Init", 0);
            appdomain.Invoke(method, null);
            updateMethod = appdomain.LoadedTypes[entryType].GetMethod("Update", 0);

...
#if UNITY_STANDALONE || UNITY_ANDROID || UNITY_IOS || SERVICE && !(WINRT || PHONE8 || COREFX)
        /// <summary>
...
#if UNITY_STANDALONE || UNITY_ANDROID || UNITY_IOS || SERVICE && !NO_GENERICS && !(WINRT || PHONE8 || COREFX)
        /// <summary>

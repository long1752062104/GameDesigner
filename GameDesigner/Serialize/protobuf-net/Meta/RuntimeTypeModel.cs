    ...
    public sealed class RuntimeTypeModel : TypeModel
    {
...
#if UNITY_STANDALONE || UNITY_ANDROID || UNITY_IOS || SERVICE && !FX11
        ...
        public override string GetSchema(Type type, ProtoSyntax syntax)
        {
            ...
            else
            {
                ...
                isInbuiltType = (ValueMember.TryGetCoreSerializer(this, DataFormat.Default, type, out WireType defaultWireType, false, false, false, false) != null);
                if (!isInbuiltType)
                {
        ...
        private void CascadeDependents(BasicList list, MetaType metaType)
        {
            ...
            if (metaType.IsList)
            {
                ...
                IProtoSerializer coreSerializer = ValueMember.TryGetCoreSerializer(this, DataFormat.Default, itemType, out WireType defaultWireType, false, false, false, false);
            ...
            else
            {
                ...
                {
                    if (MetaType.ResolveTupleConstructor(metaType.Type, out MemberInfo[] mapping) != null)
                    {
                        for (int i = 0; i < mapping.Length; i++)
                        {
                            ...
                            IProtoSerializer coreSerializer = ValueMember.TryGetCoreSerializer(this, DataFormat.Default, type, out WireType defaultWireType, false, false, false, false);
                            if (coreSerializer == null)
                            {
                                int index = FindOrAddAuto(type, false, false, false);
                                if (index >= 0)
...
#if UNITY_STANDALONE || UNITY_ANDROID || UNITY_IOS || SERVICE && !FX11 && !DEBUG
            AutoCompile = true;
#endif
        }
        ...
        internal int FindOrAddAuto(Type type, bool demand, bool addWithContractOnly, bool addEvenIfAutoDisabled)
        {
            ...
            if (key < 0)
            {
                ...
                {
                    Net.Event.NDebug.LogError("解析错误:" + ex);
                }
                finally
                {
                    ReleaseLock(opaqueToken);
            ...
            int IComparable.CompareTo(object obj)
            {
                ...
                else
                {
                    ...
                    { // both are involved in inheritance
                        int result = BaseKey.CompareTo(other.BaseKey);
        ...
        public sealed class CompilerOptions
        {
            ...
            public void SetFrameworkOptions(MetaType from)
            {
                ...
                foreach (AttributeMap attrib in attribs)
                {
                    ...
                    {
                        if (attrib.TryGet("FrameworkName", out object tmp)) TargetFrameworkName = (string)tmp;
...
#pragma warning restore 0618
            ...
            WriteSerializers(options, assemblyName, type, out int index, out bool hasInheritance, out SerializerPair[] methodPairs, out Compiler.CompilerContext.ILVersion ilVersion);

            WriteGetKeyImpl(type, hasInheritance, methodPairs, ilVersion, assemblyName, out ILGenerator il, out int knownTypesCategory, out FieldBuilder knownTypes, out Type knownTypesLookupType);
...
,
            ...
            if (internalsVisibleToAttribType != null)
            {
                ...
                foreach (MetaType metaType in types)
                {
                    ...
                    for (int i = 0; i < assemblyAttribsMap.Length; i++)
                    {
                        ...
                        assemblyAttribsMap[i].TryGet("AssemblyName", out object privelegedAssemblyObj);
        ...
        internal string GetSchemaTypeName(Type effectiveType, DataFormat dataFormat, bool asReference, bool dynamicType, ref CommonImports imports)
        {
            ...
            IProtoSerializer ser = ValueMember.TryGetCoreSerializer(this, dataFormat, effectiveType, out WireType wireType, false, false, false, false);
            if (ser == null)
            {   // model type

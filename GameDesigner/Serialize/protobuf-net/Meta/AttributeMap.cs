...
#else
#if WINRT || COREFX
            Attribute[] all = (Attribute[])System.Linq.Enumerable.ToArray(type.GetTypeInfo().GetCustomAttributes(inherit));
#else
...
#else
#if WINRT || COREFX
            Attribute[] all = (Attribute[])System.Linq.Enumerable.ToArray(member.GetCustomAttributes(inherit));
#else

...
namespace Binding
{
	public struct UnityEngineRectBind : ISerialize<UnityEngine.Rect>
	{
		public void Write(UnityEngine.Rect value, Segment strem)
		{
		...
		public UnityEngine.Rect Read(Segment strem)
		{
...
namespace Binding
{
	public struct UnityEngineRectArrayBind : ISerialize<UnityEngine.Rect[]>
	{
		public void Write(UnityEngine.Rect[] value, Segment strem)
		{
...
namespace Binding
{
	public struct UnityEngineRectGenericBind : ISerialize<List<UnityEngine.Rect>>
	{
		public void Write(List<UnityEngine.Rect> value, Segment strem)
		{
		...
		public List<UnityEngine.Rect> Read(Segment strem)
		{
			var count = strem.ReadValue<int>();

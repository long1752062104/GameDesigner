...
namespace Net.System
{
    ...
    internal sealed class QueueSafeDebugView<T>
    {
        ...
        public QueueSafeDebugView(IProducerConsumerCollection<T> collection)
        {
    ...
    /// <remarks>
    /// All public  and protected members of <see cref="QueueSafe{T}"/> are thread-safe and may be used
    /// concurrently from multiple threads.
    /// </remarks>
    [DebuggerDisplay("Count = {Count}")]
    [DebuggerTypeProxy(typeof(QueueSafeDebugView<>))]
    public class QueueSafe<T> : IProducerConsumerCollection<T>, IReadOnlyCollection<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueSafe{T}"/> class.
        /// </summary>
        public QueueSafe()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueueSafe{T}"/>
        /// class that contains elements copied from the specified collection
        /// </summary>
        /// <param name="collection">The collection whose elements are copied to the new <see
        /// cref="QueueSafe{T}"/>.</param>
        /// <exception cref="T:System.ArgumentNullException">The <paramref name="collection"/> argument is
        /// null.</exception>
        public QueueSafe(IEnumerable<T> collection)
        {
            if (collection == null)
            {
        ...
        /// with the SyncRoot; otherwise, false. For <see cref="QueueSafe{T}"/>, this property always
        /// returns false.</value>
        ...
        /// <remarks>For <see cref="QueueSafe{T}"/>, this operation will always add the object to the
        /// end of the <see cref="QueueSafe{T}"/>
        ...
        /// <remarks>For <see cref="QueueSafe{T}"/>, this operation will attempt to remove the object
        /// from the beginning of the <see cref="QueueSafe{T}"/>.
        /// </remarks>
        ...
        /// <summary>
        /// Gets a value that indicates whether the <see cref="QueueSafe{T}"/> is empty.
        /// </summary>
        /// <value>true if the <see cref="QueueSafe{T}"/> is empty; otherwise, false.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Copies the elements stored in the <see cref="QueueSafe{T}"/> to a new array.
        /// </summary>
        /// <returns>A new array containing a snapshot of elements copied from the <see
        /// cref="QueueSafe{T}"/>.</returns>
        public T[] ToArray()
        {
        ...
        /// <summary>
        /// Copies the <see cref="QueueSafe{T}"/> elements to a new <see
        /// cref="T:System.Collections.Generic.List{T}"/>.
        /// </summary>
        /// <returns>A new <see cref="T:System.Collections.Generic.List{T}"/> containing a snapshot of
        /// elements copied from the <see cref="QueueSafe{T}"/>.</returns>
        private List<T> ToList()
        {
            ...
            try
            {
                ...
                GetHeadTailPositions(out Segment head, out Segment tail, out int headLow, out int tailHigh);
        ...
        /// <summary>
        /// Gets the number of elements contained in the <see cref="QueueSafe{T}"/>.
        /// </summary>
        /// <value>The number of elements contained in the <see cref="QueueSafe{T}"/>.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Copies the <see cref="QueueSafe{T}"/> elements to an existing one-dimensional <see
        /// cref="T:System.Array">Array</see>, starting at the specified array index.
        /// </summary>
        /// <param name="array">The one-dimensional <see cref="T:System.Array">Array</see> that is the
        /// destination of the elements copied from the
        /// <see cref="QueueSafe{T}"/>. The <see cref="T:System.Array">Array</see> must have zero-based
        /// indexing.</param>
        /// <param name="index">The zero-based index in <paramref name="array"/> at which copying
        /// begins.</param>
        /// <exception cref="ArgumentNullException"><paramref name="array"/> is a null reference (Nothing in
        ...
        /// -or- The number of elements in the source <see cref="QueueSafe{T}"/> is greater than the
        ...
        /// <summary>
        /// Adds an object to the end of the <see cref="QueueSafe{T}"/>.
        /// </summary>
        /// <param name="item">The object to add to the end of the <see
        /// cref="QueueSafe{T}"/>. The value can be a null reference
        ...
        private class Segment
        {
            ...
            private volatile QueueSafe<T> m_source;

            /// <summary>
            /// Create and initialize a segment with the specified index.
            /// </summary>
            internal Segment(long index, QueueSafe<T> source)
            {
            ...
            internal bool TryAppend(T value)
            {
                ...
                int newhigh = Interlocked.Increment(ref m_high);
            ...
            internal bool TryRemove(out T result)
            {
                ...
                while (lowLocal <= highLocal)
                {
                    ...
                    if (Interlocked.CompareExchange(ref m_low, lowLocal + 1, lowLocal) == lowLocal)
                    {
                        ...
                        {
                            m_array[lowLocal] = default; //release the reference to the object. 
                        }

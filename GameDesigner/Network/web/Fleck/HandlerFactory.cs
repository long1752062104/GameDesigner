...
namespace Fleck
{
    ...
    {
        public static IHandler BuildHandler(WebSocketHttpRequest request, Action<byte[],string> onMessage, Action onClose, Action<byte[]> onBinary, Action<byte[]> onPing, Action<byte[]> onPong)
        {

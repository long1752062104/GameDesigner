...
namespace ILRuntime.Runtime.Intepreter
{
    ...
    class FunctionDelegateAdapter<TResult> : DelegateAdapter
    {
        ...
        {
            using (InvocationContext ctx = BeginInvoke())
            {
                StackObject* esp = ILInvoke(ctx.Intepreter, ctx.ESP, ctx.ManagedStack);
                ctx.SetInvoked(esp);
        ...
        {
            FunctionDelegateAdapter<TResult> res = new FunctionDelegateAdapter<TResult>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class FunctionDelegateAdapter<T1, TResult> : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            FunctionDelegateAdapter<T1, TResult> res = new FunctionDelegateAdapter<T1, TResult>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class FunctionDelegateAdapter<T1, T2, TResult> : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            FunctionDelegateAdapter<T1, T2, TResult> res = new FunctionDelegateAdapter<T1, T2, TResult>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class FunctionDelegateAdapter<T1, T2, T3, TResult> : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            FunctionDelegateAdapter<T1, T2, T3, TResult> res = new FunctionDelegateAdapter<T1, T2, T3, TResult>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
        public override void Combine(Delegate dele)
    ...
    class FunctionDelegateAdapter<T1, T2, T3, T4, TResult> : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            FunctionDelegateAdapter<T1, T2, T3, T4, TResult> res = new FunctionDelegateAdapter<T1, T2, T3, T4, TResult>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class MethodDelegateAdapter<T1> : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            MethodDelegateAdapter<T1> res = new MethodDelegateAdapter<T1>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class MethodDelegateAdapter<T1, T2> : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            MethodDelegateAdapter<T1, T2> res = new MethodDelegateAdapter<T1, T2>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class MethodDelegateAdapter<T1, T2, T3> : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            MethodDelegateAdapter<T1, T2, T3> res = new MethodDelegateAdapter<T1, T2, T3>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class MethodDelegateAdapter<T1, T2, T3, T4> : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            MethodDelegateAdapter<T1, T2, T3, T4> res = new MethodDelegateAdapter<T1, T2, T3, T4>(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class MethodDelegateAdapter : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            MethodDelegateAdapter res = new MethodDelegateAdapter(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    class DummyDelegateAdapter : DelegateAdapter
    {
        ...
        public override IDelegateAdapter Clone()
        {
            DummyDelegateAdapter res = new DummyDelegateAdapter(appdomain, instance, method);
            res.isClone = true;
            return res;
        }
    ...
    abstract class DelegateAdapter : ILTypeInstance, IDelegateAdapter
    {
        ...
        {
            InvocationContext ctx = appdomain.BeginInvoke(method);
        ...
        unsafe StackObject* ILInvokeSub(ILIntepreter intp, StackObject* esp, IList<object> mStack)
        {
            ...
            StackObject* ret = intp.Execute(method, esp, out bool unhandled);
            if (next != null)
            {
        ...
        unsafe StackObject* ClearStack(ILIntepreter intp, StackObject* esp, StackObject* ebp, IList<object> mStack)
        {
            ...
            StackObject* returnVal = Minus(ebp, paramCnt + 1);
        ...
        public override bool CanAssignTo(IType type)
        {
            if (type.IsDelegate)
            {
                IMethod im = type.GetMethod("Invoke", method.ParameterCount);
        ...
        public Delegate GetConvertor(Type type)
        {
            ...
            if (converters.TryGetValue(type, out Delegate res))
                return res;
            else
            {
        ...
        public static void ThrowAdapterNotFound(IMethod method)
        {
            ...
            if (method.ReturnType.Name != "Void" || method.ParameterCount > 0)
            {
                ...
                if (method.ReturnType.Name == "Void")
                {
                    ...
                    bool first = true;
                    foreach (IType i in method.Parameters)
                    {
                        if (first)
                        {
                            first = false;

...
#pragma warning disable CS0414
        ...
        public object Run(ILMethod method, object instance, object[] p)
        {
            ...
            esp = Execute(method, esp, out bool unhandledException);
        ...
        internal StackObject* Execute(ILMethod method, StackObject* esp, out bool unhandledException)
        {
            ...
            stack.InitializeFrame(method, esp, out StackFrame frame);
...
#if DEBUG && !DISABLE_ILRUNTIME_DEBUG
                object thisObj = RetriveObject(arg, mStack);
                if (thisObj == null)
                    throw new NullReferenceException();
#endif
            }
            ...
            for (int i = 0; i < method.LocalVariableCount; i++)
            {
                Mono.Cecil.Cil.VariableDefinition v = method.Variables[i];
                bool isEnum = false;
                Mono.Cecil.TypeReference vt = v.VariableType;
                IType t;
            ...
            StackObject* bp = stack.ValueTypeStackPointer;
            ...
            fixed (OpCode* ptr = body)
            {
                ...
                while (!returned)
                {
                    try
                    {
                        ...
                        switch (code)
                        {
                            ...
                            case OpCodeEnum.Stloc_S:
                                {
                                    esp--;
                                    StackObject* v = Add(frame.LocalVarPointer, ip->TokenInteger);
                            ...
                            case OpCodeEnum.Ldobj:
                                {
                                    ...
                                    switch (objRef->ObjectType)
                                    {
                                        case ObjectTypes.ArrayReference:
                                            {
                                                IType t = AppDomain.GetType(ip->TokenInteger);
                                        ...
                                        case ObjectTypes.StaticFieldReference:
                                            {
                                                IType t = AppDomain.GetType(objRef->Value);
                                                int idx = objRef->ValueLow;
                                                Free(objRef);
                                                if (t is ILType)
                                                {
                            ...
                            case OpCodeEnum.Ldind_U4:
                                {
                                    ...
                                    switch (val->ObjectType)
                                    {
                                        case ObjectTypes.FieldReference:
                                            {
                                                object instance = mStack[val->Value];
                            ...
                            case OpCodeEnum.Switch:
                                {
                                    ...
                                    Free(esp - 1);
                                    esp--;
                                    int[] table = method.JumpTables[ip->TokenInteger];
                            ...
                            case OpCodeEnum.Leave_S:
                                {
                                    if (method.ExceptionHandler != null)
                                    {
                                        ...
                                        IEnumerable<ExceptionHandler> sql = from e in method.ExceptionHandler
                            ...
                            case OpCodeEnum.Callvirt:
                                {
                                    ...
                                    else
                                    {
                                        if (m is ILMethod)
                                        {
                                            ...
                                            {
                                                object instance = StackObject.ToObject((Minus(esp, m.ParameterCount + 1)), domain, mStack);
                                            ...
                                            if (!processed)
                                            {
                                                if (code == OpCodeEnum.Callvirt)
                                                {
                                                    ...
                                                    {
                                                        dst = ILIntepreter.ResolveReference(objRef);
                                                        ILType ft = domain.GetType(dst->Value) as ILType;
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                object instance = StackObject.ToObject((Minus(esp, cm.ParameterCount + 1)), domain, mStack);
                                                if (instance is IDelegateAdapter)
                                                {
                                                    esp = ((IDelegateAdapter)instance).ILInvoke(this, esp, mStack);
                                                    processed = true;
                                            ...
                                            if (!processed)
                                            {
                                                CLRRedirectionDelegate redirect = cm.Redirection;
                                                if (redirect != null)
                            ...
                            case OpCodeEnum.Stfld:
                                {
                                    ...
                                    {
                                        dst = ILIntepreter.ResolveReference(objRef);
                                        IType ft = domain.GetType(dst->Value);
                                        if (ft is ILType)
                                    ...
                                    else
                                    {
                                        ...
                                        if (obj != null)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                {
                                                    val = esp - 1;
                                                    int fieldToken = (int)ip->TokenLong;
                                                    System.Reflection.FieldInfo f = ((CLRType)type).GetField(fieldToken);
                                                    ...
                                                    if (t.IsValueType)
                                                    {
                                                        switch (objRef->ObjectType)
                                                        {
                                                            ...
                                                            case ObjectTypes.FieldReference:
                                                                {
                                                                    object oldObj = mStack[objRef->Value];
                                                                    int idx = objRef->ValueLow;
                                                                    ...
                                                                    {
                                                                        IType it = AppDomain.GetType(oldObj.GetType());
                                                            ...
                                                            case ObjectTypes.StaticFieldReference:
                                                                {
                                                                    IType it = AppDomain.GetType(objRef->Value);
                                                                    int idx = objRef->ValueLow;
                                                                    if (it is ILType)
                                                                    {
                                                            ...
                                                            case ObjectTypes.ValueTypeObjectReference:
                                                                {
                                                                    dst = ILIntepreter.ResolveReference(objRef);
                                                                    CLRType ct = domain.GetType(dst->Value) as CLRType;
                                                                    ValueTypeBinder binder = ct.ValueTypeBinder;
                                    ...
                                    else
                                    {
                                        ...
                                        if (obj != null)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (type != null)
                                                {
                                                    int token = (int)ip->TokenLong;
                                                    if (!((CLRType)type).CopyFieldToStack(token, obj, this, ref ret, mStack))
                                                    {
                                                        System.Reflection.FieldInfo ft = ((CLRType)type).GetField(token);
                            ...
                            case OpCodeEnum.Ldflda:
                                {
                                    ...
                                    {
                                        dst = esp - 1;
                                        IType ft = domain.GetType((int)(ip->TokenLong >> 32));
                            ...
                            case OpCodeEnum.Stsfld:
                                {
                                    ...
                                    if (type != null)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            System.Reflection.FieldInfo f = t.GetField(idx);
                                            val = esp - 1;
                                            obj = null;
                            ...
                            case OpCodeEnum.Newobj:
                                {
                                    ...
                                    if (m is ILMethod)
                                    {
                                        ...
                                        {
                                            objRef = GetObjectAndResolveReference(esp - 1 - 1);
                                            IMethod mi = (IMethod)mStack[(esp - 1)->Value];
                                            object ins;
                                            if (objRef->ObjectType == ObjectTypes.Null)
                                                ins = null;
                                            else
                                            ...
                                            esp = esp - 1 - 1;
                                            object dele;
                                            ILMethod ilMethod = mi as ILMethod;
                                            if (ilMethod != null)
                                            {
                                                if (ins != null)
                                                {
                                                    ...
                                                    if (dele == null)
                                                    {
                                                        IMethod invokeMethod = type.GetMethod("Invoke", mi.ParameterCount);
                                            ...
                                            if (cm.DeclearingType.IsDelegate)
                                            {
                                                ...
                                                if (ilMethod != null)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        if (ilMethod.DelegateAdapter == null)
                                                        {
                                                            IMethod invokeMethod = cm.DeclearingType.GetMethod("Invoke", mi.ParameterCount);
                                                            ilMethod.DelegateAdapter = domain.DelegateManager.FindDelegateAdapter(null, ilMethod, invokeMethod);
                                                        }
                                                        dele = ilMethod.DelegateAdapter;
                                                    }
                            ...
                            case OpCodeEnum.Constrained:
                                {
                                    ...
                                    IMethod m = domain.GetMethod((int)ip->TokenLong);
                                    int pCnt = m.ParameterCount;
                                    objRef = Minus(esp, pCnt + 1);
                                    int insIdx = mStack.Count;
                                    if (objRef->ObjectType < ObjectTypes.Object)
                                    {
                                        ...
                                        {
                                            StackObject* pPtr = Minus(esp, i + 1);
                                            if (pPtr->ObjectType >= ObjectTypes.Object)
                                            {
                                                int oldVal = pPtr->Value;
                                                insIdx--;
                                                if (!moved)
                                                {
                                        ...
                                        if (type is ILType)
                                        {
                                            ...
                                            if (t.IsEnum)
                                            {
                                                ...
                                                switch (objRef2->ObjectType)
                                                {
                                                    case ObjectTypes.FieldReference:
                                                        {
                                                            ILTypeInstance owner = mStack[objRef2->Value] as ILTypeInstance;
                                                    ...
                                                    case ObjectTypes.StaticFieldReference:
                                                        {
                                                            ILType st = AppDomain.GetType(objRef2->Value) as ILType;
                                                            int idx = objRef2->ValueLow;
                                                            //Free(objRef);
                                                    ...
                                                    case ObjectTypes.ArrayReference:
                                                        {
                                                            object arr = mStack[objRef2->Value];
                                                            int idx = objRef2->ValueLow;
                                                            //Free(objRef);
                                    ...
                                    if (type != null)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                {
                                                    dst = ILIntepreter.ResolveReference(objRef);
                                                    IType vt = domain.GetType(dst->Value);
                                                    if (vt != type)
                            ...
                            case OpCodeEnum.Unbox_Any:
                                {
                                    ...
                                    if (objRef->ObjectType == ObjectTypes.Object)
                                    {
                                        ...
                                        if (obj != null)
                                        {
                                            IType t = domain.GetType(ip->TokenInteger);
                                            if (t != null)
                                            {
                                                ...
                                                else if (t.IsValueType)
                                                {
                                                    if (obj is ILTypeInstance)
                                                    {
                                                        ILTypeInstance res = ((ILTypeInstance)obj);
                                    ...
                                    if (type is ILType)
                                    {
                                                ...
                                                case ObjectTypes.FieldReference:
                                                    {
                                                        ...
                                                        if (obj != null)
                                                        {
                                                            ...
                                                            {
                                                                ILTypeInstance instance = obj as ILTypeInstance;
                                                                ILTypeInstance tar = instance[objRef->ValueLow] as ILTypeInstance;
                                                                if (tar != null)
                                                                    tar.Clear();
                                                                else
                                                                    throw new NotSupportedException();
                                                ...
                                                case ObjectTypes.StaticFieldReference:
                                                    {
                                                        ...
                                                        if (t is ILType)
                                                        {
                                                            ILTypeInstance tar = ((ILType)t).StaticInstance[idx] as ILTypeInstance;
                                                            if (tar != null)
                                                                tar.Clear();
                                                            else
                                                                throw new NotSupportedException();
                                        ...
                                        else
                                        {
                                            ...
                                            switch (objRef->ObjectType)
                                            {
                                                case ObjectTypes.StaticFieldReference:
                                                    {
                                                        ILType t = AppDomain.GetType(objRef->Value) as ILType;
                                                        t.StaticInstance.AssignFromStack(objRef->ValueLow, esp, AppDomain, mStack);
                                                    }
                                                    break;
                                                case ObjectTypes.FieldReference:
                                                    {
                                                        ILTypeInstance instance = mStack[objRef->Value] as ILTypeInstance;
                            ...
                            case OpCodeEnum.Throw:
                                {
                                    objRef = GetObjectAndResolveReference(esp - 1);
                                    Exception ex = mStack[objRef->Value] as Exception;
                                    Free(objRef);
                                    esp--;
                                    throw ex;
                                }
                    ...
                    catch (Exception ex)
                    {
                        ...
                        {
                            int addr = (int)(ip - ptr);
                            ExceptionHandler eh = GetCorrespondingExceptionHandler(method, ex, addr, ExceptionHandlerType.Catch, true);
                            ...
                            if (eh != null)
                            {
                                if (ex is ILRuntimeException)
                                {
                                    ...
                                    Exception inner = ire.InnerException;
                                ...
                                {
                                    DebugService debugger = AppDomain.DebugService;
                                    if (method.HasThis)
                                ...
                                {
                                    StackFrame f = stack.Frames.Peek();
...
#endif
                        {
                            ILRuntimeException newEx = new ILRuntimeException(ex.Message, this, method, ex);
                            throw newEx;
                        }
                    }
                }
        ...
        {
            IType sType = AppDomain.GetType(src->Value);
            IType dType = AppDomain.GetType(dst->Value);
        ...
        void CopyValueTypeToStack(StackObject* dst, object ins, IList<object> mStack)
        {
            ...
            else
            {
                ...
                {
                    ValueTypeBinder vb = ((CLRType)domain.GetType(dst->Value)).ValueTypeBinder;
            ...
            switch (esp->ObjectType)
            {
                ...
                case ObjectTypes.ArrayReference:
                    if (v->ObjectType == ObjectTypes.ValueTypeObjectReference)
                    {
                        ...
                        if (obj is ILTypeInstance)
                        {
                            StackObject* dst = ILIntepreter.ResolveReference(v);
                ...
                case ObjectTypes.FieldReference:
                    {
                        ...
                        {
                            IType t = AppDomain.GetType(obj.GetType());
                            obj = ((CLRType)t).GetFieldValue(idx, obj);
                        }
                    }
                    break;
        ...
        ExceptionHandler GetCorrespondingExceptionHandler(ILMethod method, object obj, int addr, ExceptionHandlerType type, bool explicitMatch)
        {
            ...
            foreach (ExceptionHandler i in method.ExceptionHandler)
            {
        ...
        void StoreValueToFieldReference(ref object obj, int idx, StackObject* val, IList<object> mStack)
        {
            ...
            else
            {
                ...
                //if (!t.AssignFieldFromStack(idx, ref obj, this, val, mStack))
                {
                    object v = obj.GetType().CheckCLRTypes(CheckAndCloneValueType(StackObject.ToObject(val, AppDomain, mStack), AppDomain));
        ...
        {
            IList<object> mStack = stack.ManagedStack;
            List<IType> plist = method.Parameters;
        ...
        public void CopyToStack(StackObject* dst, StackObject* src, IList<object> mStack)
        {
            ...
            {
                StackObject* descriptor = ResolveReference(src);
                IType t = domain.GetType(descriptor->Value);
        ...
        internal static object CheckAndCloneValueType(object obj, Enviorment.AppDomain domain)
        {
            if (obj != null)
            {
                ...
                else
                {
                    ...
                    CLR.Utils.Extensions.TypeFlags typeFlags = type.GetTypeFlags();

                    bool isPrimitive = (typeFlags & CLR.Utils.Extensions.TypeFlags.IsPrimitive) != 0;
                    bool isValueType = (typeFlags & CLR.Utils.Extensions.TypeFlags.IsValueType) != 0;

                    if (!isPrimitive && isValueType)
                    {
                        IType t = domain.GetType(type);
        ...
        public static void UnboxObject(StackObject* esp, object obj, IList<object> mStack = null, Enviorment.AppDomain domain = null)
        {
            if (esp->ObjectType == ObjectTypes.ValueTypeObjectReference && domain != null)
            {
                ...
                {
                    ILTypeInstance ins = ((CrossBindingAdaptorType)obj).ILInstance;
                    ins.CopyValueTypeToStack(dst, mStack);
                }
                else
                {
        ...
        public static StackObject* PushObject(StackObject* esp, IList<object> mStack, object obj, bool isBox = false)
        {
            if (obj != null)
            {
                if (!isBox)
                {
                    CLR.Utils.Extensions.TypeFlags typeFlags = obj.GetType().GetTypeFlags();
        ...
        public void FreeStackValueType(StackObject* esp)
        {
            ...
            {
                StackObject* addr = ILIntepreter.ResolveReference(esp);

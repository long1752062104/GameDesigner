...
namespace ILRuntime.Runtime.Enviorment
{
                ...
                case ObjectTypes.ValueTypeObjectReference:
                    {
                        ...
                        ValueTypeBinder<K> vb = ((CLRType)domain.GetType(dst->Value)).ValueTypeBinder as ValueTypeBinder<K>;
                        if (vb != null)
                        {
        ...
        where T : struct
    {
        ...
        {
            StackObject* a = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            if (a->ObjectType == ObjectTypes.ValueTypeObjectReference)
            {
                StackObject* ptr = ILIntepreter.ResolveReference(a);
        ...
        public void WriteBackValue(ILRuntime.Runtime.Enviorment.AppDomain domain, StackObject* ptr_of_this_method, IList<object> mStack, ref T instance_of_this_method)
        {
            ...
            switch (ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.FieldReference:
                    {
                        object obj = mStack[ptr_of_this_method->Value];
                        ...
                        {
                            CLRType t = domain.GetType(obj.GetType()) as CLRType;
                ...
                case ObjectTypes.StaticFieldReference:
                    {
                        IType t = domain.GetType(ptr_of_this_method->Value);
                        if (t is ILType)
                        {
                ...
                case ObjectTypes.ArrayReference:
                    {
                        T[] instance_of_arrayReference = mStack[ptr_of_this_method->Value] as T[];
                        instance_of_arrayReference[ptr_of_this_method->ValueLow] = instance_of_this_method;
                    }
                    break;
                case ObjectTypes.ValueTypeObjectReference:
                    {
                        StackObject* dst = ILIntepreter.ResolveReference(ptr_of_this_method);

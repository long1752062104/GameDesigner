...
namespace ILRuntime.Runtime.Enviorment
{
    unsafe static class CLRRedirections
    {
        ...
        {
            StackObject* p = esp - 1 - 1;
            Type t = mStack[p->Value] as Type;
            StackObject* p2 = esp - 1;
            object[] t2 = mStack[p2->Value] as Object[];
            intp.Free(p);
            if (t != null)
            {
        ...
        public static StackObject* GetType(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method, bool isNewObj)
        {
            ...
            intp.Free(p);
            IType t = intp.AppDomain.GetType(fullname);
            if (t != null)
        ...
        public static StackObject* TypeEquals(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method, bool isNewObj)
        {
            ...
            StackObject* p = esp - 1;
            AppDomain dommain = intp.AppDomain;
            object other = StackObject.ToObject(p, dommain, mStack);
            intp.Free(p);
            p = ILIntepreter.Minus(esp, 2);
            object instance = StackObject.ToObject(p, dommain, mStack);
            intp.Free(p);
        ...
        public unsafe static StackObject* InitializeArray(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method, bool isNewObj)
        {
            ...
            fixed (byte* p = data)
            {
                ...
                System.Runtime.InteropServices.GCHandle handle = System.Runtime.InteropServices.GCHandle.Alloc(arr, System.Runtime.InteropServices.GCHandleType.Pinned);
                IntPtr dst = System.Runtime.InteropServices.Marshal.UnsafeAddrOfPinnedArrayElement(arr, 0);
            ...
            if (dele1 != null)
            {
                if (dele2 != null)
                {
                    if (dele1 is IDelegateAdapter)
                    {
                        ...
                        {
                            IDelegateAdapter dele = ((IDelegateAdapter)dele1);
        ...
        public unsafe static StackObject* MethodInfoInvoke(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method, bool isNewObj)
        {
            ...
            StackObject* param = esp - 1;
            object p = StackObject.ToObject(param, domain, mStack);
            intp.Free(param);

            param = esp - 1 - 1;
            object obj = StackObject.ToObject(param, domain, mStack);
            intp.Free(param);
            ...
            if (instance is ILRuntimeMethodInfo)
            {
                if (obj != null)
                    ...
                    esp = ret;
                ILMethod ilmethod = ((ILRuntimeMethodInfo)instance).ILMethod;
                if (p != null)
                {
                    object[] arr = (object[])p;
                ...
                ret = intp.Execute(ilmethod, esp, out bool unhandled);
                ILRuntimeMethodInfo imi = (ILRuntimeMethodInfo)instance;
                IType rt = imi.ILMethod.ReturnType;
                if (rt != domain.VoidType)
                {
                    StackObject* res = ret - 1;
        ...
        public static StackObject* EnumParse(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method, bool isNewObj)
        {
            ...
            if (t is ILRuntimeType)
            {
                ...
                if (it.IsEnum)
                {
                    Mono.Collections.Generic.Collection<Mono.Cecil.FieldDefinition> fields = it.TypeDefinition.Fields;

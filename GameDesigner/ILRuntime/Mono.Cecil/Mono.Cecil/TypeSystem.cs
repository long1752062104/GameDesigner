...
namespace ILRuntime.Mono.Cecil
{
    ...
    public abstract class TypeSystem
    {
        ...
        sealed class CoreTypeSystem : TypeSystem
        {
            ...
            TypeReference LookupTypeForwarded(string @namespace, string name)
            {
                ...
                Collections.Generic.Collection<ExportedType> exported_types = module.ExportedTypes;
    ...
    static partial class Mixin
    {
        ...
        {
            Collections.Generic.Collection<AssemblyNameReference> references = module.AssemblyReferences;

...
namespace ILRuntime.Mono.Cecil
{
    ...
    public sealed class TypeDefinition : TypeReference, IMemberDefinition, ISecurityDeclarationProvider
    {
        ...
        public override bool IsPrimitive
        {
            get
            {
                return MetadataSystem.TryGetPrimitiveElementType(this, out ElementType primitive_etype) && primitive_etype.IsPrimitive();
            }
        }
        ...
        public override MetadataType MetadataType
        {
            get
            {
                if (MetadataSystem.TryGetPrimitiveElementType(this, out ElementType primitive_etype))

...
namespace ILRuntime.Mono.Cecil
{
    ...
    class TypeParser
    {
        ...
        {
            if (!TryGetArity(name, out int type_arity))
                return;
        ...
        static TypeReference TryCreateGenericInstanceType(TypeReference type, Type type_info)
        {
            ...
            Collections.Generic.Collection<TypeReference> instance_arguments = instance.GenericArguments;
        ...
        {
            if (!TryGetArity(type.Name, out int arity))
                return;
        ...
        static IMetadataScope GetMetadataScope(ModuleDefinition module, Type type_info)
        {
            ...
            return module.TryGetAssemblyNameReference(reference, out AssemblyNameReference match)
                ? match
                : reference;
        }
        ...
        static void AppendTypeSpecification(TypeSpecification type, StringBuilder name)
        {
            ...
            switch (type.etype)
            {
                ...
                case ElementType.GenericInst:
                    ...
                    Collections.Generic.Collection<TypeReference> arguments = instance.GenericArguments;

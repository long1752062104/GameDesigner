...
namespace ILRuntime.Mono.Cecil.Cil
{
    ...
    public sealed class MethodDebugInformation : DebugInformation
    {
        ...
        public IDictionary<Instruction, SequencePoint> GetSequencePointMapping()
        {
            ...
            Dictionary<int, SequencePoint> offset_mapping = new Dictionary<int, SequencePoint>(sequence_points.Count);
            ...
            {
                if (offset_mapping.TryGetValue(instructions[i].Offset, out SequencePoint sequence_point))
        ...
        public bool TryGetName(VariableDefinition variable, out string name)
        {
            ...
            {
                if (!scope.TryGetName(variable, out string slot_name))
                    continue;
    ...
    static class SymbolProvider
    {
        ...
        static SR.AssemblyName GetSymbolAssemblyName(SymbolKind kind)
        {
            ...
            SR.AssemblyName name = new SR.AssemblyName
            {
...
namespace ILRuntime.Mono.Cecil
{
    ...
    static partial class Mixin
    {
        ...
        {
            ImageDebugHeaderEntry entry = new ImageDebugHeaderEntry(new ImageDebugDirectory { Type = ImageDebugType.Deterministic }, Empty<byte>.Array);
            if (header == null)

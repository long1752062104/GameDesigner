...
namespace FixMath
{
    ...
    public struct F32 : IComparable<F32>, IEquatable<F32>
    {
        ...
        //public static implicit operator F32(int i) { return new F32(i); }
        //public static implicit operator F32(float f) { return new F32(f); }
        //public static implicit operator F32(double d) { return new F32(d); }
        //public static implicit operator F32(F32 f) { return new F32(f); }

        public static implicit operator float(F32 f) { return f.Float; }
        public static implicit operator double(F32 d) { return d.Double; }
        ...
        public static F32 operator -(F32 v1, int v2) { return FromRaw(v1.Raw - Fixed32.FromInt(v2)); }
        public static F32 operator -(int v1, F32 v2) { return FromRaw(Fixed32.FromInt(v1) - v2.Raw); }
        public static F32 operator *(F32 v1, int v2) { return FromRaw(v1.Raw * v2); }
        public static F32 operator *(int v1, F32 v2) { return FromRaw(v1 * v2.Raw); }
        public static F32 operator /(F32 v1, int v2) { return FromRaw(v1.Raw / v2); }
        ...
        public static F32 FromF32(F32 v) { return new F32(v); }
